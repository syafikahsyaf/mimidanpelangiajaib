...
document.addEventListener('DOMContentLoaded', () => {
  const start = async () => {
    ...
    const mixers = [];
    mixers.push(await loadPage(0, '../../assets/models/g7/page1.glb', '../../assets/sounds/BMmap/place1bm.mp3'));
    mixers.push(await loadPage(1, '../../assets/models/g7/page2.glb', '../../assets/sounds/BMmap/place2bm.mp3'));
    mixers.push(await loadPage(2, '../../assets/models/g7/page3.glb', '../../assets/sounds/BMmap/place3bm.mp3'));
    mixers.push(await loadPage(3, '../../assets/models/g7/page4.glb', '../../assets/sounds/BMmap/place4bm.mp3'));
    mixers.push(await loadPage(4, '../../assets/models/g7/page5.glb', '../../assets/sounds/BMmap/place5bm.mp3'));
    mixers.push(await loadPage(5, '../../assets/models/g7/page6.glb', '../../assets/sounds/BMmap/place6bm.mp3'));
    mixers.push(await loadPage(6, '../../assets/models/g7/page7.glb', '../../assets/sounds/BMmap/place7bm.mp3'));
    mixers.push(await loadPage(7, '../../assets/models/g7/page9.glb', '../../assets/sounds/BMmap/place8bm.mp3'));
    mixers.push(await loadPage(8, '../../assets/models/g7/page11.glb', '../../assets/sounds/BMmap/place9bm.mp3'));
