...
document.addEventListener('DOMContentLoaded', () => {
  const start = async () => {
    ...
    const mixers = [];
    mixers.push(await loadPage(0, '../../assets/models/g7/page1.glb', '../../assets/sounds/BM/page1bm.mp3'));
    mixers.push(await loadPage(1, '../../assets/models/g7/page2.glb', '../../assets/sounds/BM/page2bm.mp3'));
    mixers.push(await loadPage(2, '../../assets/models/g7/page3.glb', '../../assets/sounds/BM/page3bm.mp3'));
    mixers.push(await loadPage(3, '../../assets/models/g7/page4.glb', '../../assets/sounds/BM/page4bm.mp3'));
    mixers.push(await loadPage(4, '../../assets/models/g7/page5.glb', '../../assets/sounds/BM/page5bm.mp3'));
    mixers.push(await loadPage(5, '../../assets/models/g7/page6.glb', '../../assets/sounds/BM/page6bm.mp3'));
    mixers.push(await loadPage(6, '../../assets/models/g7/page7.glb', '../../assets/sounds/BM/page7bm.mp3'));
    mixers.push(await loadPage(7, '../../assets/models/g7/page8.glb', '../../assets/sounds/BM/page8bm.mp3'));
    mixers.push(await loadPage(8, '../../assets/models/g7/page9.glb', '../../assets/sounds/BM/page9bm.mp3'));
    mixers.push(await loadPage(9, '../../assets/models/g7/page10.glb', '../../assets/sounds/BM/page10bm.mp3'));  // Page 10
    mixers.push(await loadPage(10, '../../assets/models/g7/page11.glb', '../../assets/sounds/BM/page11bm.mp3'));  // Page 11
