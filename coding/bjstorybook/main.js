...
document.addEventListener('DOMContentLoaded', () => {
  const start = async () => {
    const mindarThree = new window.MINDAR.IMAGE.MindARThree({
      ...
      imageTargetSrc: '../../assets/targets/storybook/storybook.mind',
    });
    ...
    const loadPage = async (pageIndex, modelPath, soundPath) => {
      ...
      switch (pageIndex) {
        ...
        case 2:  // Page 3
          ...
          break;
        case 3:  // Page 4
          page.scene.scale.set(0.4, 0.4, 0.4);
          break;
        case 4:  // Page 5
          page.scene.scale.set(0.8, 0.8, 0.8);
          break;
        case 5:  // Page 6
          page.scene.scale.set(0.6, 0.6, 0.6);
          break;
        case 6:  // Page 7
          page.scene.scale.set(0.2, 0.2, 0.2);
          break;
        case 7:  // Page 8
          page.scene.scale.set(0.05, 0.05, 0.05);
          break;
        case 8:  // Page 9
          page.scene.scale.set(0.2, 0.2, 0.2);
          break;
        case 9:  // Page 10
          page.scene.scale.set(0.2, 0.2, 0.2);  // Custom scale for page 10
          break;
        case 10:  // Page 11
          page.scene.scale.set(0.2, 0.2, 0.2);  // Custom scale for page 11
          break;
        default:
    ...
    const mixers = [];
    mixers.push(await loadPage(0, '../../assets/models/g7/page1.glb', '../../assets/sounds/BJ/page1bj.mp3'));
    mixers.push(await loadPage(1, '../../assets/models/g7/page2.glb', '../../assets/sounds/BJ/page2bj.mp3'));
    mixers.push(await loadPage(2, '../../assets/models/g7/page3.glb', '../../assets/sounds/BJ/page3bj.mp3'));
    mixers.push(await loadPage(3, '../../assets/models/g7/page4.glb', '../../assets/sounds/BJ/page4bj.mp3'));
    mixers.push(await loadPage(4, '../../assets/models/g7/page5.glb', '../../assets/sounds/BJ/page5bj.mp3'));
    mixers.push(await loadPage(5, '../../assets/models/g7/page6.glb', '../../assets/sounds/BJ/page6bj.mp3'));
    mixers.push(await loadPage(6, '../../assets/models/g7/page7.glb', '../../assets/sounds/BJ/page7bj.mp3'));
    mixers.push(await loadPage(7, '../../assets/models/g7/page8.glb', '../../assets/sounds/BJ/page8bj.mp3'));
    mixers.push(await loadPage(8, '../../assets/models/g7/page9.glb', '../../assets/sounds/BJ/page9bj.mp3'));
    mixers.push(await loadPage(9, '../../assets/models/g7/page10.glb', '../../assets/sounds/BJ/page10bj.mp3'));  // Page 10
    mixers.push(await loadPage(10, '../../assets/models/g7/page11.glb', '../../assets/sounds/BJ/page11bj.mp3'));  // Page 11
